...
const App: React.FC = () => {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    if (password.toLowerCase() === ITI_NICKNAME) {
      ...
      alert("This world is only for Iti. Please enter your name to enter 💙");
    }
  };
      ...
      <div className="max-w-6xl w-full mx-auto space-y-8 sm:space-y-16 py-8 sm:py-12">
        <header className="text-center space-y-4 sm:space-y-6 animate-reveal-up">
          <div className="inline-block px-4 py-1.5 glass-dark rounded-full border border-rose-200/50 mb-2">
            <span className="text-rose-900 font-black text-[9px] sm:text-[10px] tracking-[0.3em] uppercase">The Valentine Chapters</span>
          </div>
          <h1 className="text-4xl sm:text-7xl font-romantic text-rose-950">8 Days of Iti</h1>
          <p className="text-rose-700 font-elegant italic text-lg sm:text-3xl shimmer-text px-4">"Small moments, designed for you."</p>
        </header>
        ...
        <div className="flex flex-col items-center justify-center space-y-6 sm:space-y-10 py-10">
          ...
          <div className="text-center space-y-2 animate-reveal-up z-30">
            ...
            <div className="flex flex-col items-center">
              <p className="text-[10px] sm:text-[11px] text-rose-400 font-black uppercase tracking-[0.3em] shimmer-text">Hold the blossom to reveal our past...</p>
        ...
        <footer className="text-center py-8 sm:py-16 space-y-6 sm:space-y-8">
          ...
          <p className="text-rose-400 font-elegant italic tracking-widest text-base sm:text-xl px-6 shimmer-text">"You are the magic in these pixels, Iti."</p>
        </footer>
      </div>
    </div>
  );
